  ...
  if(props.value == "Add Review"){
    return (
      <div>
		...
		<div class="relative z-0 mb-9 w-full group">
			<input value={id} onChange={handleIdChange} autoComplete='off' type="text" name="floating_userid" id="floating_password" class="block ml-4 py-2.5 px-0 w-80 lg:w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
		...
		<div class="relative z-0 mb-9 w-full group">
			<input value={text} onChange={handleTextChange} autoComplete="off" type="text" name="repeat_review" id="floating_repeat_password" class="block ml-4 py-2.5 px-0 w-80 lg:w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
